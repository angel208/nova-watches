			...
			<div class="container">
				...
				<div class="row">
					...
					if ( isset( $shop_isle_site_info_hide ) && $shop_isle_site_info_hide != 1 ) {
						echo apply_filters( 'shop_isle_site_info', '<p class="shop-isle-poweredby-box"><a class="shop-isle-poweredby" href="http://themeisle.com/themes/shop-isle/" rel="nofollow">Angel Peña - angel.fp204@gmail.com </a></p>' );
					}
					echo '</div>';
